...
urlpatterns = [
    ...
    path('v4/user/self', myapp_view.user_info, name='user_info'),
    path('v4/user', myapp_view.create_user, name='create_user'),
    path('v4/verify', myapp_view.verify_user, name='verify_user'),
